...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net s_axis_txd_1 [get_bd_intf_pins axi_ethernet_2/s_axis_txd] [get_bd_intf_pins axi_ethernet_3/m_axis_rxd]
