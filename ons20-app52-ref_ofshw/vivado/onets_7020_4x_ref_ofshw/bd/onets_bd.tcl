...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net packet_pipeline_v1_0_0_m_axis_txc_0 [get_bd_intf_pins axi_ethernet_0/s_axis_txc] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txc_0]
  connect_bd_intf_net -intf_net packet_pipeline_v1_0_0_m_axis_txd_0 [get_bd_intf_pins axi_ethernet_0/s_axis_txd] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txd_0]
  connect_bd_intf_net -intf_net packet_pipeline_v1_0_0_m_axis_txd_1 [get_bd_intf_pins axi_ethernet_1/s_axis_txd] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txd_1]
  ...
  connect_bd_intf_net -intf_net packet_pipeline_v1_0_0_m_axis_txd_3 [get_bd_intf_pins axi_ethernet_3/s_axis_txd] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txd_3]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins packet_pipeline_v1_0_0/s_axi_lite] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net s_axis_txc_1 [get_bd_intf_pins axi_ethernet_1/s_axis_txc] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txc_1]
  connect_bd_intf_net -intf_net s_axis_txc_2 [get_bd_intf_pins axi_ethernet_2/s_axis_txc] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txc_2]
  connect_bd_intf_net -intf_net s_axis_txc_3 [get_bd_intf_pins axi_ethernet_3/s_axis_txc] [get_bd_intf_pins packet_pipeline_v1_0_0/m_axis_txc_3]
  ...
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_ethernet_0/axi_rxd_arstn] [get_bd_pins axi_ethernet_0/axi_rxs_arstn] [get_bd_pins axi_ethernet_0/axi_txc_arstn] [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_1/axi_rxd_arstn] [get_bd_pins axi_ethernet_1/axi_rxs_arstn] [get_bd_pins axi_ethernet_1/axi_txc_arstn] [get_bd_pins axi_ethernet_1/axi_txd_arstn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_2/axi_rxd_arstn] [get_bd_pins axi_ethernet_2/axi_rxs_arstn] [get_bd_pins axi_ethernet_2/axi_txc_arstn] [get_bd_pins axi_ethernet_2/axi_txd_arstn] [get_bd_pins axi_ethernet_2/s_axi_lite_resetn] [get_bd_pins axi_ethernet_3/axi_rxd_arstn] [get_bd_pins axi_ethernet_3/axi_rxs_arstn] [get_bd_pins axi_ethernet_3/axi_txc_arstn] [get_bd_pins axi_ethernet_3/axi_txd_arstn] [get_bd_pins axi_ethernet_3/s_axi_lite_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins dma2eth_intercon_0/aresetn] [get_bd_pins eth2dma_intercon_0/aresetn] [get_bd_pins packet_pipeline_v1_0_0/s_axi_lite_aresetn] [get_bd_pins packet_pipeline_v1_0_0/s_axis_mm2s_aresetn] [get_bd_pins packet_pipeline_v1_0_0/s_axis_rxd_aresetn] [get_bd_pins packet_pipeline_v1_0_0/s_axis_s2mm_aresetn] [get_bd_pins packet_pipeline_v1_0_0/s_axis_txd_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_ports bd_fclk1_75m] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins axi_ethernet_2/s_axi_lite_clk] [get_bd_pins axi_ethernet_3/s_axi_lite_clk] [get_bd_pins packet_pipeline_v1_0_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_fclk_clk1 [get_bd_ports bd_fclk0_125m] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/gtx_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_2/axis_clk] [get_bd_pins axi_ethernet_3/axis_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins dma2eth_intercon_0/aclk] [get_bd_pins eth2dma_intercon_0/aclk] [get_bd_pins packet_pipeline_v1_0_0/s_axis_mm2s_aclk] [get_bd_pins packet_pipeline_v1_0_0/s_axis_rxd_aclk] [get_bd_pins packet_pipeline_v1_0_0/s_axis_s2mm_aclk] [get_bd_pins packet_pipeline_v1_0_0/s_axis_txd_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
